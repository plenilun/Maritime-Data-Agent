...
def build_trace_record(
    *,
    ...
    data_update_time: Any,
    warnings: list[str] | None = None,
) -> dict[str, Any]:
    tables_used = route_info.get("tables_used") or ([route_info.get("table_name")] if route_info.get("table_name") else [])
    return {
        ...
        "join_plan": route_info.get("join_plan", []),
        "multi_table": route_info.get("multi_table", False),
        "fields_used": columns,
        "generated_sql": sql,
    ...
    *,
    ...
    return {
        ...
        "methodology": {
            ...
            "join_plan": trace_record.get("join_plan", []),
        },
        "trace_summary": {
